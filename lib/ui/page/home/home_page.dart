...
class _HomePageState extends State<HomePage> {
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "Aplikasi RMOL BENGKULU Telah Update di Playstore!!",
  ...
  setFCM() async {
    ...
    if(subscribeNotif == null || subscribeNotif == "subscribed")
      _firebaseMessaging.subscribeToTopic("rmolbengkulu_public");
    else 
      _firebaseMessaging.unsubscribeFromTopic("rmolbengkulu_public");
