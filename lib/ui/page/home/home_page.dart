...
class _HomePageState extends State<HomePage> {
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "Aplikasi RMOL SUMUT Telah Update di Playstore!!",
  ...
  setFCM() async {
    ...
    if(subscribeNotif == null || subscribeNotif == "subscribed")
      _firebaseMessaging.subscribeToTopic("rmolsumut_public");
    else 
      _firebaseMessaging.unsubscribeFromTopic("rmolsumut_public");
