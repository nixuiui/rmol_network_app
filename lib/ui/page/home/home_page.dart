...
class _HomePageState extends State<HomePage> {
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "Aplikasi RMOL SUMSEL Telah Update di Playstore!!",
  ...
  setFCM() async {
    ...
    if(subscribeNotif == null || subscribeNotif == "subscribed")
      _firebaseMessaging.subscribeToTopic("rmolsumsel_public");
    else 
      _firebaseMessaging.unsubscribeFromTopic("rmolsumsel_public");
