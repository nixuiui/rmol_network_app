...
class MainApi {
  String host = "https://rmoldkijakarta.id/rest/api";
  Dio dio = Dio();
  ...
  Future<String> postRequest({
    ...
    if (connectivityResult == ConnectivityResult.none) throw "Tidak ada koneksi internet";
    ...
    try {
      ...
      if (response.statusCode == 200) {
        return jsonEncode(jsonDecode(response.data) ?? jsonDecode(response.data)['message']);
